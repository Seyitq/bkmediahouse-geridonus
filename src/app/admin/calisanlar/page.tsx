    ...
    return (
        <div className="space-y-6">
            ...
            <div className="space-y-3">
                <h2 className="text-lg font-semibold text-white">Mevcut Çalışanlar ({employees.length})</h2>
                ...
                {employees.length === 0 ? (
                    ...
                    <div className="grid gap-3 grid-cols-1 md:grid-cols-2">
                        {employees.map((emp) => {
                            ...
                            return (
                                <Card key={emp.id} className="border-zinc-800 bg-zinc-900/50 hover:bg-zinc-900/80 transition-colors">
