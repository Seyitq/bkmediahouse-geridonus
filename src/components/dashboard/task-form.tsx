            ...
            <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="title" className="text-zinc-300">Görev Başlığı *</Label>
                        <input
                            id="title"
                            name="title"
                            type="text"
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="w-full rounded-lg border border-zinc-700 bg-zinc-800 px-4 py-2.5 text-sm text-white placeholder:text-zinc-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 resize-none"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            <Label htmlFor="assignedToId" className="text-zinc-300">Atanan Kişi</Label>
                            <select
                                id="assignedToId"
                                name="assignedToId"
                                defaultValue={task?.assignedToId || ''}
                                className="w-full rounded-lg border border-zinc-700 bg-zinc-800 px-4 py-2.5 text-sm text-white focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                            >
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="categoryId" className="text-zinc-300">Kategori</Label>
                            <select
                                id="categoryId"
                                name="categoryId"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            <Label htmlFor="projectName" className="text-zinc-300">Proje Adı</Label>
                            <input
                                id="projectName"
                                name="projectName"
                                type="text"
                    ...
                    {/* Project Part */}
                    <div className="space-y-2">
                        <Label htmlFor="projectPart" className="text-zinc-300">Projenin Hangi Kısmı</Label>
                        <input
                            id="projectPart"
                            name="projectPart"
                            type="text"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="space-y-2">
                            <Label htmlFor="priority" className="text-zinc-300">Öncelik</Label>
                            <select
                                id="priority"
                                name="priority"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="deadline" className="text-zinc-300">Son Tarih</Label>
                            <input
                                id="deadline"
                                name="deadline"
                                type="date"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="amount" className="text-zinc-300">Tutar (₺)</Label>
                            <input
                                id="amount"
                                name="amount"
                                type="number"
